...
const Hero = () => {
  return (
    <section className="min-h-screen flex flex-col justify-center relative overflow-hidden">
      ...
      {/* Radial glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full opacity-[0.04] pointer-events-none" style={{
        ...
        <div className="grid lg:grid-cols-[1fr_auto] gap-12 lg:gap-20 items-center w-full">
          <div className="max-w-2xl">
            ...
            <motion.h1
              ...
              className="font-serif text-5xl md:text-6xl lg:text-7xl leading-[1.05] tracking-tight text-foreground mb-6 [text-wrap:balance]"
            >
              Security Controls
              <br />
